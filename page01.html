...
<body>
    ...
    <p>කතාව කියවන්න නම් මේ විදිහට කරන්න. <br><br> 
        ...
        එතකොට ඔයාව කතාවට කෙලින්ම යයි, <br><br>
        රතු පාට බටන් එක ඔබලා එන පිටුවේ තප්පර 20ක් ඉන්නෙ නැතුව කොළ පාට බටන් එක එබුවට වැඩ කරන්නෙ නෑ.. <br><br>
        ඒක නිසා කියපු විදිහට පිලිවෙලට කරන්න</p>

    <button id="redButton" class="btnRed2">ඔබන්න</button><br><br>
    <button id="greenButton" disabled class="btnGreen2">කතාවට යන්න</button>
    ...
    <script>
        ...
        redButton.addEventListener('click', function() {
            ...
            window.location.href = 'https://www.highcpmgate.com/haewgtg25?key=e74ac98721dec374cec7b54036948e29';
        ...
        greenButton.addEventListener('click', function() {
            ...
            if (!redButtonClicked) {
                ...
                window.location.href = 'https://storyhux.blogspot.com/2024/04/blog-post_12.html';
            }
        });
